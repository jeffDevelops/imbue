...
export interface StyledDrawerProps {
   ...
   * other elements in the stacking order; if whole object not provided, defaults are applied
   */
  zIndex?: {
    /** The z-index of the drawer when the user mouses down on it; defaults to 9999 */
    focused: number
    /** The z-index of the drawer when the user clicks away from it; defaults to 1 */
    blurred: number
  }
