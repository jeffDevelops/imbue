...
export const CustomRadio = styled.div<StyledRadioProps>`
  position: relative;
  display: flex;
  ...
  &:focus {
    ...
    &:active {
      ...
      transform: ${p.theme.radioButton.clicked.transform};
    }
  `}
  ...
  ${p =>
    ...
    background-color: ${
      p.theme.radioButton.checked.backgroundColor
    };
    box-shadow: ${getCSSForBoxShadow(
  ...
  ${p =>
    ...
    background-color: ${p.theme.radioButton.disabled.color};
...
export const Label = styled.label<StyledRadioProps>`
  ...
  ${p =>
    !p.disabled &&
    `
    &:hover ${CustomRadio}, &:focus ${CustomRadio} {
      background-color: ${
